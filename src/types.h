...
typedef struct MVMJitCpuReg MVMJitCpuReg;
typedef struct MVMJitStore MVMJitStore;
typedef struct MVMJitCallC MVMJitCallC;
typedef struct MVMJitAddress MVMJitAddress;
typedef struct MVMJitLoad MVMJitLoad;
typedef struct MVMJitLiteral MVMJitLiteral;
typedef struct MVMJitArith MVMJitArith;
